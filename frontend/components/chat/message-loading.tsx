export default function MessageLoading() {
   return (
      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="text-foreground" aria-labelledby="messageLoadingTitle">
         <title id="messageLoadingTitle">Loading message</title>
